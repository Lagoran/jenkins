...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(depth0,helpers,partials,data) {
  ...
  return "		<div class=\"selected-plugin "
    ...
    + "\" id=\"installing-"
    + alias3(__default(__webpack_require__(7)).call(depth0,(depth0 != null ? depth0.name : depth0),{"name":"id","hash":{},"data":data}))
    + "\" data-tooltip=\""
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(depth0,helpers,partials,data,blockParams,depths) {
  ...
  return "<h2 id=\""
    + alias1(__default(__webpack_require__(7)).call(depth0,(data && data.key),{"name":"id","hash":{},"data":data}))
    + "\" class=\"expanded\">"
  ...
  return "  <div class=\"plugin "
    + alias1(__default(__webpack_require__(7)).call(depth0,((stack1 = (depth0 != null ? depth0.plugin : depth0)) != null ? stack1.name : stack1),{"name":"id","hash":{},"data":data}))
    + " "
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(depth0,helpers,partials,data) {
  ...
  return "    <li><a href=\"#"
    + alias1(__default(__webpack_require__(7)).call(depth0,depth0,{"name":"id","hash":{},"data":data}))
  ...
  return "<div class=\"modal-header closeable\">\n  <h4 class=\"modal-title\">"
    ...
    + "</div>\n"
    + ((stack1 = this.invokePartial(__webpack_require__(16),depth0,{"name":"pluginSelectList","data":data,"indent":"        ","helpers":helpers,"partials":partials})) != null ? stack1 : "")
...
// EXTERNAL MODULE: ./src/main/js/util/jenkins.js
var jenkins = __webpack_require__(2);

// EXTERNAL MODULE: ./src/main/js/api/pluginManager.js
...
function securityConfig_saveFirstUser($form, success, error) {
  jenkins["a" /* default */].staplerPost('/setupWizard/createAdminUser', $form, function (response) {
    var crumbRequestField = response.data.crumbRequestField;

    if (crumbRequestField) {
      Object(window_handle["getWindow"])().crumb.init(crumbRequestField, response.data.crumb);
    }
...
function securityConfig_saveConfigureInstance($form, success, error) {
  jenkins["a" /* default */].staplerPost('/setupWizard/configureInstance', $form, function (response) {
    var crumbRequestField = response.data.crumbRequestField;
...
function saveProxy($form, success, error) {
  jenkins["a" /* default */].staplerPost('/pluginManager/proxyConfigure', $form, success, {
    dataType: 'html',
    error: error
  });
}
...
/* harmony default export */ var securityConfig = ({
  saveFirstUser: securityConfig_saveFirstUser,
  saveConfigureInstance: securityConfig_saveConfigureInstance,
  saveProxy: saveProxy
});
// EXTERNAL MODULE: ./src/main/js/handlebars-helpers/id.js
var id = __webpack_require__(7);
...
function enhanceJQueryWithBootstrap($) {
  var window = Object(window_handle["getWindow"])();
  var _$ = window.$;
...
var welcomePanel = __webpack_require__(26);
...
var progressPanel = __webpack_require__(12);
...
var successPanel = __webpack_require__(27);
...
var pluginSelectionPanel = __webpack_require__(28);
...
var setupCompletePanel = __webpack_require__(29);
...
var proxyConfigPanel = __webpack_require__(30);
...
var firstUserPanel = __webpack_require__(31);
...
var configureInstance = __webpack_require__(19);
...
var offlinePanel = __webpack_require__(32);
...
var pluginSetupWizard = __webpack_require__(33);
...
var incompleteInstallationPanel = __webpack_require__(34);
...
var pluginSelectList = __webpack_require__(16);
...
runtime_default.a.registerPartial('pluginSelectList', pluginSelectList_default.a); // TODO: see whether this is actually being used or if it can be removed

window.zq = jquery_default.a; // Setup the dialog, exported

var createPluginSetupWizard = function (appendTarget) {
  var $bs = enhanceJQueryWithBootstrap(jquery_default.a); // Necessary handlebars helpers:
  // returns the plugin count string per category selected vs. available e.g. (5/44)

  runtime_default.a.registerHelper('pluginCountForCategory', function (cat) {
  ...
  runtime_default.a.registerHelper('totalPluginCount', function () {
    var tot = 0;
    var cnt = 0;
  ...
  runtime_default.a.registerHelper('inSelectedPlugins', function (val, options) {
    if (selectedPluginNames.indexOf(val) >= 0) {
      return options.fn();
    }
  }); // executes a block if there are dependencies

  runtime_default.a.registerHelper('hasDependencies', function (plugName, options) {
  ...
  runtime_default.a.registerHelper('dependencyCount', function (plugName) {
    var plug = availablePlugins[plugName];
  ...
  runtime_default.a.registerHelper('eachDependency', function (plugName, options) {
    var plug = availablePlugins[plugName];
    ...
    var deps = jquery_default.a.grep(plug.allDependencies, function (value) {
      // remove self
  ...
  runtime_default.a.registerHelper('ifVisibleDependency', function (plugName, options) {
  ...
  var setPanel = function (panel, data, onComplete) {
    ...
    var oncomplete = function () {
      ...
      if ($content.length > 0) {
        $content.each(function () {
          ...
          jenkins["a" /* default */].get($el.attr('data-load-content'), function (data) {
            $el.html(data);
    ...
    var html = panel(jquery_default.a.extend({
      translations: translations,
      baseUrl: jenkins["a" /* default */].baseUrl,
  ...
  var initInstallingPluginList = function () {
    ...
    for (var i = 0; i < selectedPluginNames.length; i++) {
      ...
      if (p) {
        var plug = jquery_default.a.extend({
  ...
  var installPlugins = function (pluginNames) {
    ...
    pluginManager["a" /* default */].installPlugins(pluginNames, handleGenericError(function () {
      showStatePanel();
    }));
  ...
  var installDefaultPlugins = function () {
    loadPluginData(function () {
      installPlugins(pluginManager["a" /* default */].recommendedPluginNames());
    });
  };
  ...
  var setupFirstUser = function () {
    setPanel(firstUserPanel_default.a, {}, enableButtonsAfterFrameLoad);
  };

  var showConfigureInstance = function (messages) {
    setPanel(configureInstance_default.a, messages, enableButtonsAfterFrameLoad);
  };

  var showSetupCompletePanel = function (messages) {
    pluginManager["a" /* default */].getRestartStatus(function (restartStatus) {
      setPanel(setupCompletePanel_default.a, jquery_default.a.extend(restartStatus, messages));
    });
  ...
  var stateHandlers = {
    DEFAULT: function () {
      setPanel(welcomePanel_default.a); // focus on default
  ...
  var showStatePanel = function (state) {
    if (!state) {
      pluginManager["a" /* default */].installStatus(handleGenericError(function (data) {
  ...
  var showInstallProgress = function () {
    ...
    if (failedPluginNames.length > 0) {
      setPanel(successPanel_default.a, {
    ...
    var attachScrollEvent = function () {
      ...
      var events = jquery_default.a._data($c[0], "events");
    ...
    setPanel(progressPanel_default.a, {
      installingPlugins: installingPlugins
      ...
      pluginManager["a" /* default */].installStatus(handleGenericError(function (data) {
        ...
        for (i = 0; i < jobs.length; i++) {
          ...
          if (txt && state) {
            ...
            $txt.append($div);
            var $itemProgress = jquery_default()('.selected-plugin[id="installing-' + Object(id["default"])(j.name) + '"]');
  ...
  var loadPluginData = function (oncomplete) {
    pluginManager["a" /* default */].availablePlugins(handleGenericError(function (availables) {
      var i, plug;
    ...
    loadPluginData(function () {
      ...
      for (var i = 0; i < pluginList.length; i++) {
        ...
        for (var c = 0; c < a.plugins.length; c++) {
          ...
          plugs.push({
            category: a.category,
            plugin: jquery_default.a.extend({}, plug, {
  ...
  var loadCustomPluginPanel = function () {
    loadPluginCategories(function () {
      setPanel(pluginSelectionPanel_default.a, pluginSelectionPanelData(), function () {
  ...
  var skipFirstUser = function () {
    ...
    jenkins["a" /* default */].get('/api/json?tree=url', function (data) {
      if (data.url) {
  ...
  var handleConfigureInstanceResponseSuccess = function (data) {
    if (data.status === 'ok') {
      ...
      setPanel(configureInstance_default.a, {}, function () {
  ...
  var setupProxy = function () {
    setPanel(proxyConfigPanel_default.a, {}, enableButtonsAfterFrameLoad);
  ...
  var saveProxyConfig = function () {
    securityConfig.saveProxy(jquery_default()('iframe[src]').contents().find('form:not(.no-json)'), function () {
      jenkins["a" /* default */].goTo('/'); // this will re-run connectivity test
    });
  ...
  var continueWithFailedPlugins = function () {
    pluginManager["a" /* default */].installPluginsDone(function () {
      pluginManager["a" /* default */].installStatus(handleGenericError(function (data) {
        failedPluginNames = [];
        showStatePanel(data.state);
      }));
  ...
  var restartJenkins = function () {
    pluginManager["a" /* default */].restartJenkins(function () {
      setPanel(loadingPanel_default.a);
      console.log('-------------------');
  ...
  var closeInstaller = function () {
    pluginManager["a" /* default */].completeInstall(handleGenericError(function () {
      jenkins["a" /* default */].goTo('/');
    }));
  };
  ...
  var actions = {
    ...
    '.plugin-select-recommended': function () {
      selectedPluginNames = pluginManager["a" /* default */].recommendedPluginNames();
      refreshPluginSelectionPanel();
    },
  ...
  setPanel(loadingPanel_default.a); // Process extensions

  var extensionTranslationOverrides = [];
  /* globals setupWizardExtensions: true */

  if ('undefined' !== typeof setupWizardExtensions) {
    jquery_default.a.each(setupWizardExtensions, function () {
      this.call(self, {
        '$': jquery_default.a,
        '$wizard': $wizard,
        jenkins: jenkins["a" /* default */],
        pluginManager: pluginManager["a" /* default */],
        setPanel: setPanel,
        addActions: function (pluginActions) {
          jquery_default.a.extend(actions, pluginActions);
        },
        addStateHandlers: function (pluginStateHandlers) {
          jquery_default.a.extend(stateHandlers, pluginStateHandlers);
        },
  ...
  var showInitialSetupWizard = function () {
    ...
    jenkins["a" /* default */].testConnectivity(defaultUpdateSiteId, handleGenericError(function (isConnected, isFatal, errorMessage) {
      if (!isConnected) {
        if (isFatal) {
          ...
          setPanel(offlinePanel_default.a);
        }
      ...
      pluginManager["a" /* default */].init(handleGenericError(function () {
        pluginList = pluginManager["a" /* default */].plugins();
        allPluginNames = pluginManager["a" /* default */].pluginNames();
        selectedPluginNames = pluginManager["a" /* default */].recommendedPluginNames(); // check for updates when first loaded...
        ...
        pluginManager["a" /* default */].installStatus(handleGenericError(function (data) {
          ...
          pluginManager["a" /* default */].incompleteInstallStatus(handleGenericError(function (incompleteStatus) {
            ...
            if (incompletePluginNames.length > 0) {
              ...
              loadPluginData(handleGenericError(function () {
                ...
                setPanel(incompleteInstallationPanel_default.a, {
                  installingPlugins: installingPlugins
                });
              }));
              return;
  ...
  jenkins["a" /* default */].loadTranslations('jenkins.install.pluginSetupWizard', handleGenericError(function (localizations) {
    translations = localizations; // process any translation overrides

    jquery_default.a.each(extensionTranslationOverrides, function () {
      this(translations);
    });
